...
export const Hamburger8 = ({ isActive }: { isActive?: boolean }) => {
    return (
        <svg className={clsx(styles.ham, styles.hamRotate, styles.ham8, isActive && styles.active)} viewBox="0 0 100 100" width="80" >
            <path
